...
route.get('/fetchproject', verifyCookie, roleCheck.role_All(false), viewProject);
...
route.get('/projects/:id', verifyCookie, singleProject);
route.get('/project/:projectId/employees', verifyCookie, roleCheck.roleAdmin(false), projectEmployee);
